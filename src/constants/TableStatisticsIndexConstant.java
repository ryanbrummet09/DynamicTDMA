...
public class TableStatisticsIndexConstant {
	...
	public static final int PACKET_TIME_IN_CURRENT_QUEUE = 17;
	public static final int PACKET_DROPPED = 18;
	public static final int PACKET_POSITION_IN_QUEUE = 19;
	...
	public static final String[] COLUMN_NAMES = {"TIME", "NODE", "NODE_BACKOFF", "NODE_CW", "NODE_QUEUE_SIZE",
			...
			"PACKET_FINAL_DEST_NODE","PACKET_SLOTS_TO_SEND_TO_NEXT_DEST", "PACKET_TIME_IN_CURRENT_QUEUE", "PACKET_DROPPED",
			"PACKET_POSITION_IN_QUEUE"};
