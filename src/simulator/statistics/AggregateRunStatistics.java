...
public class AggregateRunStatistics {
	 ...
	 * @return
	 */
	public static int getNumPacketsReceivedByNode(String targetNodeName, Topology topology, Simulator oldSimulator) {
		List<Node> nodes = oldSimulator.getNodes();
	 ...
	 * @return
	 */
	public static int getNumPacketsSentByNode(String targetNodeName, Topology topology, Simulator oldSimulator) {
		List<Node> nodes = oldSimulator.getNodes();
